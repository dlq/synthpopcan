...
| [Simulation interoperability](2026-07-15-simulation-interoperability.md) | Planned and conditional | `0.8.0` neutral bundle; adapter pilot only after `1.0.0` | Define and validate the simulator-neutral exchange bundle without adding a target-specific pre-`1.0` surface. |
