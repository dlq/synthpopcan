...
| [Research-software stewardship](2026-07-19-research-software-stewardship.md) | Active maintenance baseline; scoped policy and archive correction completed | Preservation, management, support, CFF, bilingual case study, embedded licensing, 64-operation correction, 32 registry updates, and 1.0 metadata complete; outreach, mirrors, and JOSS later | Preserve exact-commit publication gates and add release DOI or Software Heritage identifiers only after the public archives mint them. |
