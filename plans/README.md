...
| [Local web application runtime](2026-07-10-local-web-application-runtime.md) | In progress (Stages 0–5 complete) | `0.6.0`; schema follow-up in `0.6.1` | Execute Stage 6: guided small-area workflow. |
