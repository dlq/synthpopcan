...
| [Small-area geography](2026-07-22-small-area-geography.md) | Completed in `0.7.0`; archive pending | `0.7.0` | Preserve the reviewed Québec proof, shared national DA/ADA plans, and bounded Nunavut executions as regression evidence. |
