...
| --- | --- | --- | --- |
| [Correctness assurance](2026-07-12-correctness-assurance.md) | Active baseline | `0.9.0` bounded assurance completed; ongoing `1.x` evidence | Inventory and freeze the declared 1.0 interfaces and persisted contracts with installed-package compatibility fixtures. |
