...
| [Research-software stewardship](2026-07-19-research-software-stewardship.md) | Active baseline; scoped policy and archive correction completed | Preservation, management, support, CFF, bilingual case study, embedded licensing, 64-operation correction, and 32 registry updates complete; outreach, mirrors, and JOSS later | Advance and validate the exact-commit `1.0.0` software release metadata. |
