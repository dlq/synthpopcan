...
| --- | --- | --- | --- |
| [Correctness assurance](2026-07-12-correctness-assurance.md) | Active baseline | `0.9.0` bounded assurance completed; 1.0 candidate compatibility evidence implemented | Run the final combined release gate, review the candidate interface-manifest diff, and freeze it only in the verified `1.0.0` release commit. |
...
| [Research-software stewardship](2026-07-19-research-software-stewardship.md) | Active baseline; permissive scoped policy and archive-correction implementation completed | Preservation, management, support, CFF, bilingual case-study, embedded licensing, and fail-closed correction implementation complete; live archive correction remains; outreach, mirrors, and JOSS later | Perform and preserve evidence for all 64 live correction operations and 32 registry updates, then advance the exact-commit software release metadata. |
